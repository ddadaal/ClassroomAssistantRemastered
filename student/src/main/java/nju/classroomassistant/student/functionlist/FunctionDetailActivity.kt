        ...
        if (savedInstanceState == null) {
            ...
            val fragment = FunctionDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(
                        FunctionDetailFragment.ARG_ITEM_ID,
                        intent.getStringExtra(FunctionDetailFragment.ARG_ITEM_ID)
                    )
                }
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
        when (item.itemId) {
            android.R.id.home -> {
                ...
                navigateUpTo(Intent(this, FunctionListActivity::class.java))
                true
            }
